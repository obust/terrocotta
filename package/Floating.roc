...
Floating := [].{
	...
	attached_position : LayoutNode(payload), Bounds, ResolvedFloatingConfig -> Pos
...
test_node : NodeId, ParentIndex, Placement, Element.LayoutConfig, Pos, Size -> LayoutNode(payload)
